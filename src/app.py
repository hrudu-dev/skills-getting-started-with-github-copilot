...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming training and water sports activities",
    ...
    "Drama Club": {
        "description": "Theater arts, acting, and performance training",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 22,
        "participants": ["david@mergington.edu", "anna@mergington.edu", "marcus@mergington.edu"]
    }
}
